    ...
    public class ReservationDao : BaseDao, IReservationDao
    {
        ...
        public void AddReservation(ReservationDto reservation)
        {
            try
            {
                ...
                cmd.Parameters.Add(new SqlParameter("@bookingDate", reservation.BookingDate));
                cmd.Parameters.Add(new SqlParameter("@checkInDate", reservation.CheckInDate));
                cmd.Parameters.Add(new SqlParameter("@checkOutDate", reservation.CheckInDate));
                ...
                cmd.Parameters.Add(new SqlParameter("@year", reservation.Year));
